...
// import org.rawkintrevo.cylon.frameprocessors.{FaceDetectorProcessor, FrameProcessor}
import org.slf4j.{Logger, LoggerFactory}

object FlinkEngineDemo {
  def main(args: Array[String]) {
    ...
    val rawVideoConsumer: FlinkKafkaConsumer010[(String, BufferedImage)] =new FlinkKafkaConsumer010[(String, BufferedImage)]("test",
    ...
    // execute program
    env.execute("Flink Cam Markup Engine")
  }
}
